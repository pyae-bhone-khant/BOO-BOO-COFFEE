    ...
    return (
        <div className="mt-30 mb-2 flex flex-col justify-center items-center text-center">
            ...
            <Link href={"/"}>
                <Button
                    asChild
                    className="mt-5 h-15 w-45 text-xl font-bold cursor-pointer 
    bg-[#6B4C3B] hover:bg-[#F2E9E4] hover:text-[#6B4C3B] 
    border-2 border-[#6B4C3B]"
                >
            ...
            <div className="relative flex justify-center w-300 h-auto mt-19">
                ...
                <Link href={"/"}>
                    <button
                        className="absolute cursor-pointer bottom-56 left-1/4 
    transform -translate-x-1/2 w-65 h-15 border-2 
    hover:text-[#F2E9E4] hover:bg-[#6B4C3B] 
    border-[#6B4C3B] text-2xl font-bold 
    bg-white text-[#6B4C3B] px-4 py-2 rounded"
                    >
                        READ OUR STORY
                    </button>
                </Link>
